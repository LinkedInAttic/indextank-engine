 ...
 * 
 * @see apache commons-lang org.apache.commons.lang.Entities
 * 
 ...
 * 
 */
public class FlaptorHtmlEntities {
     ...
     * </p>
     */
    public static final FlaptorHtmlEntities XML;
     ...
     * </p>
     */
    public static final FlaptorHtmlEntities HTML32;
     ...
     * </p>
     */
    public static final FlaptorHtmlEntities HTML40;

    static {
        FlaptorHtmlEntities xml = new FlaptorHtmlEntities();
    ...
    static {
        FlaptorHtmlEntities html32 = new FlaptorHtmlEntities();
    ...
    static {
        FlaptorHtmlEntities html40 = new FlaptorHtmlEntities();
     ...
     */
    static void fillWithHtml40Entities(FlaptorHtmlEntities entities) {
    ...
    static abstract class MapIntMap implements FlaptorHtmlEntities.EntityMap {
     ...
     * Default constructor.
     */
    public FlaptorHtmlEntities(){
        map = new FlaptorHtmlEntities.LookupEntityMap();
    }
     ...
     */
    FlaptorHtmlEntities(EntityMap emap){
        map = emap;
    }
    ...
    public void escape(Writer writer, String str) throws IOException {
      this.escape(writer, str, 0, str.length());
    }
    ...
    public void escape(StringBuilder dest, String str, int start, int offset) {
        for (int i = start; i < offset; i++) {
            char c = str.charAt(i);
            String entityName = this.entityName(c);
            if (entityName == null) {
